          ...
          <>
            ...
            <label className="block text-sm font-medium text-gray-700">
              ...
              <textarea
                ...
                className="mt-1.5 w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100"
                rows={3}
              />
            </label>
          </>
          ...
          <div className="space-y-2">
            {filteredSubjects.length === 0 ? (
              ...
              <button
                ...
                className={`w-full rounded-lg border px-3 py-3 text-left transition ${String(activeId) === String(subject.id) ? 'border-blue-200 bg-blue-50' : 'border-gray-100 hover:bg-gray-50'}`}
              >
